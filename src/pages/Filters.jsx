  ...
  return (
    <>
      <MultiSelect
        ...
        setSelectedOptions={setSelectedExperiances}
        placeholder="Experience"
      />
      <MultiSelect
        options={workplaceOptions}
        setSelectedOptions={setSelectedWorkplaces}
        placeholder="Workplace Type"
      />
      <MultiSelect
        options={commitmentOptions}
        setSelectedOptions={setSelectedCommitment}
      ...
      <MultiSelect
        ...
        setSelectedOptions={setSelectedDegree}
        placeholder="Degree"
      />
      <MultiSelect
        options={publishDateOptions}
        setSelectedOptions={setSelectedPublishDate}
